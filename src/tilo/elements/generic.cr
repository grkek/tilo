  ...
  module Elements
    class Generic < Node
      ...
      private def handle_event(id : String, event_name : String, arguments)
        source_code = ["globalThis[\"", id, "\"]", ".", "properties", ".", event_name, "()"].join unless arguments
        source_code = ["globalThis[\"", id, "\"]", ".", "properties", ".", event_name, "(", arguments.to_json, ")"].join if arguments
