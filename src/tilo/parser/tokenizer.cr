module Tilo
  module Parser
    class Tokenizer
      ...
      def initialize(text : String, @content_directory : String)
        @text = text
        @position = 0
      end
        ...
        if next_char == '/'
          ...
          when "Switch"
            ...
            if child = custom_components[tag_name]?
              ...
              begin
                File.open(content_directory + "/pages/" + child.attributes["src"].to_s) do |fd|
                  ...
                  tokenizer = Parser::Tokenizer.new(document, content_directory)
